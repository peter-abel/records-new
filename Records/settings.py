...
SECRET_KEY = "django-insecure-*@ov*1c($w0jkobo+r!oi9wft+#ar=-u&2x-0xov1f12nenon@"
...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER': 'postgres',
        'PASSWORD': 'aA46Ea33FDaa11b3E6AfD*3*2fF-5gD2',
...
AUTHENTICATION_BACKENDS = [
    ...
    'home.backends.EmailBackend',  # Replace 'yourapp' with the name of your app
]
